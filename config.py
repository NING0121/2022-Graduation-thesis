...
def arg_parse():
    ...
    parser.add_argument('--checkpoint_moniter_metirc', default='valid_BLEU_SCORE')
    parser.add_argument('--checkpoint_filename', default='ConvS2S-{epoch:02d}-{valid_BLEU_SCORE:.2f}')
