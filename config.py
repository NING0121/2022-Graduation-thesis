...
def arg_parse():
    ...
    parser.add_argument('--checkpoint_filename', default='casie100-bertbasecoref-{epoch:02d}-{valid_avg_f1:.2f}')
    ...
    parser.add_argument('--enc_hid_dropout', default=0.3, help='')
    parser.add_argument('--readout_dropout', default=0.3 , help='')
    parser.add_argument('--enc_ninp', default=310, type=int, help='')
    parser.add_argument('--dec_ninp', default=310, type=int, help='')
    parser.add_argument('--enc_nhid', default=500, type=int, help='')
    parser.add_argument('--dec_nhid', default=500, type=int, help='')
    parser.add_argument('--dec_natt', default=500, type=int, help='')
    ...
    parser.add_argument('--beta1', default=0.9, type=int, help='')
    parser.add_argument('--beta2', default=0.98, type=int, help='')
    parser.add_argument('--epsilon', default=10e-9, type=int, help='')
    # ConvS2S
    parser.add_argument('--embedding_size', default=96, help='96')
    parser.add_argument('--out_embedding_size', default=256, help='attention weight size')
    parser.add_argument('--max_positions', default=1024, help='')
    parser.add_argument('--convolutions', default= [(96,3)]*9+[(128,3)]*5+[(256,1)]*2, help='')
    parser.add_argument('--fconv_dropout', default=0.1, type=int, help='')
    parser.add_argument('--hidden_size', default=512, type=int, help='')
    parser.add_argument('--kernel_size', default=5, type=int, help='')
    parser.add_argument('--enc_layers', default=2, type=int, help='')
    parser.add_argument('--dec_layers', default=2, type=int, help='')
